...
Вывод команды `terraform workspace list`.
```bash
ayaz@ayaz-HVY-WXX9:~/PycharmProjects/devops-netology/homeworks/02-git-01-vcs/terraform$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.vm-for["3"] will be created
  + resource "yandex_compute_instance" "vm-for" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
  ...
  # yandex_storage_bucket.my_bucket_for_state will be created
...
Вывод команды `terraform plan` для воркспейса `prod`. 
```bash
ayaz@ayaz-HVY-WXX9:~/PycharmProjects/devops-netology/homeworks/02-git-01-vcs/terraform$ terraform workspace list
  default
* prod
  stage
```
