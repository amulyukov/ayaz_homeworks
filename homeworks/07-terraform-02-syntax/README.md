...
```bash
ayaz@netology:~/git/devops-netology/homeworks/02-git-01-vcs/terraform$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_image.ubuntu2004img will be created
  + resource "yandex_compute_image" "ubuntu2004img" {
...
ayaz@netology:~/git/devops-netology/homeworks/02-git-01-vcs/terraform$ terraform apply
...
yandex_compute_image.ubuntu2004img: Creating...
yandex_compute_image.ubuntu2004img: Still creating... [10s elapsed]
yandex_compute_image.ubuntu2004img: Creation complete after 14s [id=fd8n97k2pd61g0tbcelt]
